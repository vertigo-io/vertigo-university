package io.vertigo.samples.dao;
...
public final class DaoPAO implements StoreServices {
	...
	*/
	...
	@io.vertigo.datamodel.task.proxy.TaskOutput(smartType = "STyDtMovieByYear", name = "movies")
	public io.vertigo.datamodel.data.model.DtList<io.vertigo.samples.dao.domain.MovieByYear> getMovieByYear() {
	...
	*/
	@io.vertigo.datamodel.task.proxy.TaskAnnotation(
		...
		limit 500""",
			taskEngineClass = io.vertigo.basics.task.TaskEngineSelect.class)
	@io.vertigo.datamodel.task.proxy.TaskOutput(smartType = "STyDtMovieDisplay", name = "movies")
	public io.vertigo.datamodel.data.model.DtList<io.vertigo.samples.dao.domain.MovieDisplay> getMovieDisplay() {
