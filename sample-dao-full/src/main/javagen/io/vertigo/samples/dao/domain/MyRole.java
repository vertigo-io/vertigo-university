...
public final class MyRole implements Entity {
	 ...
	 * @return Long movId
	 */
	@io.vertigo.datamodel.data.stereotype.ForeignKey(smartType = "STyId", label = "Movie", fkDefinition = "DtMyMovie" )
	 ...
	 * @return Long actId
	 */
	@io.vertigo.datamodel.data.stereotype.ForeignKey(smartType = "STyId", label = "Actor", fkDefinition = "DtMyActor" )
