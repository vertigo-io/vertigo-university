...
public final class Base implements Entity {
	...
	@io.vertigo.dynamo.domain.stereotype.Association(
			...
			foreignMultiplicity = "0..*")
	private final ListVAccessor<io.mars.base.domain.Picture> picturesAccessor = new ListVAccessor<>(this, "A_BASE_PICTURE", "Pictures");
	...
	@Deprecated
	public io.mars.base.domain.BaseType getBaseType() {
	 ...
	 */
	public ListVAccessor<io.mars.base.domain.Picture> pictures() {
		return picturesAccessor;
	}
	
	/**
	 * Association : Base Pictures.
	 * @return DtList de io.mars.base.domain.Picture
	 */
	@Deprecated
	public io.vertigo.dynamo.domain.model.DtList<io.mars.base.domain.Picture> getPicturesList() {
		// we keep the lazyness
