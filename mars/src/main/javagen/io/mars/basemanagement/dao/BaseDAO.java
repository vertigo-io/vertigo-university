...
public final class BaseDAO extends DAO<Base, java.lang.Long> implements StoreServices {
	 ...
	 */
	@Inject
	public BaseDAO(final StoreManager storeManager, final TaskManager taskManager, final SearchManager searchManager, final VTransactionManager transactionManager) {
	 ...
	 */
	 public Base readOneForUpdate(final URI<Base> uri) {
...
/**
	 ...
	 */
	public void markAsDirty(final URI<Base> entityUri) {
