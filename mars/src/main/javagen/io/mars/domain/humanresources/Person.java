...
public final class Person implements Entity {
	...
	private final VAccessor<io.mars.domain.humanresources.Mission> missionIdAccessor = new VAccessor<>(io.mars.domain.humanresources.Mission.class, "Mission");
	 ...
	 */
	public VAccessor<io.mars.domain.humanresources.Mission> mission() {
		return missionIdAccessor;
	}
	
	@Deprecated
	public io.mars.domain.humanresources.Mission getMission() {
	 ...
	 */
	@Deprecated
	public io.vertigo.dynamo.domain.model.URI<io.mars.domain.humanresources.Mission> getMissionURI() {
