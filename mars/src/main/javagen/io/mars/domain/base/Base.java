...
public final class Base implements Entity {
	...
	private final VAccessor<io.mars.domain.base.BaseType> baseTypeIdAccessor = new VAccessor<>(io.mars.domain.base.BaseType.class, "BaseType");
	...
	@io.vertigo.dynamo.domain.stereotype.Association(
			...
			foreignMultiplicity = "0..*")
	private final ListVAccessor<io.mars.domain.base.Equipment> baseEquipmentsAccessor = new ListVAccessor<>(this, "A_BASE_EQUIPMENT", "BaseEquipments");
	...
	@io.vertigo.dynamo.domain.stereotype.Association(
			...
			foreignMultiplicity = "0..*")
	private final ListVAccessor<io.mars.domain.base.Picture> picturesAccessor = new ListVAccessor<>(this, "A_BASE_PICTURE", "Pictures");
	 ...
	 */
	public VAccessor<io.mars.domain.base.BaseType> baseType() {
		return baseTypeIdAccessor;
	}
	
	@Deprecated
	public io.mars.domain.base.BaseType getBaseType() {
	 ...
	 */
	@Deprecated
	public io.vertigo.dynamo.domain.model.URI<io.mars.domain.base.BaseType> getBaseTypeURI() {
	 ...
	 */
	public ListVAccessor<io.mars.domain.base.Equipment> baseEquipments() {
		return baseEquipmentsAccessor;
	}
	
	/**
	 * Association : Base Equipments.
	 * @return DtList de io.mars.domain.base.Equipment
	 */
	@Deprecated
	public io.vertigo.dynamo.domain.model.DtList<io.mars.domain.base.Equipment> getBaseEquipmentsList() {
		// we keep the lazyness
	 ...
	 */
	public ListVAccessor<io.mars.domain.base.Picture> pictures() {
		return picturesAccessor;
	}
	
	/**
	 * Association : Base Pictures.
	 * @return DtList de io.mars.domain.base.Picture
	 */
	@Deprecated
	public io.vertigo.dynamo.domain.model.DtList<io.mars.domain.base.Picture> getPicturesList() {
		// we keep the lazyness
