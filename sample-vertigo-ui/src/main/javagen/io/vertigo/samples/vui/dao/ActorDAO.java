...
public final class ActorDAO extends DAO<Actor, java.lang.Long> implements StoreServices {
	...
	*/
	...
	public io.vertigo.datamodel.data.model.DtList<io.vertigo.samples.vui.domain.Actor> getActorsByMovie(@io.vertigo.datamodel.task.proxy.TaskInput(name = "movId", smartType = "STyId") final Long movId) {
