package io.vertigo.pandora.search.persons;
 ...
 */
@Generated
public final class PersonSearchClient implements Component {
	 ...
	 */
	@Inject
	public PersonSearchClient(final SearchManager searchManager, final VTransactionManager transactionManager) {
	...
	public SearchQueryBuilder createSearchQueryBuilderPerson(final String criteria, final SelectedFacetValues selectedFacetValues) {
		final FacetedQueryDefinition facetedQueryDefinition = Home.getApp().getDefinitionSpace().resolve("QryPerson", FacetedQueryDefinition.class);
