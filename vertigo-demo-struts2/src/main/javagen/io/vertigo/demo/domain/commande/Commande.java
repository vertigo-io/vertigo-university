...
public final class Commande implements Entity {
	...
	private final VAccessor<io.vertigo.demo.domain.commande.Client> cliIdAccessor = new VAccessor<>(io.vertigo.demo.domain.commande.Client.class, "client");
	...
	public Long getCliId() {
		return (Long)  cliIdAccessor.getId();
	}
