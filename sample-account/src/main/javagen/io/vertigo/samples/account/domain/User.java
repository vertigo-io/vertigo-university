...
public final class User implements Entity {
	 ...
	 */
	@io.vertigo.datamodel.data.stereotype.ForeignKey(smartType = "STyId", label = "Country", fkDefinition = "DtCountry", cardinality = io.vertigo.core.lang.Cardinality.ONE )
	 ...
	 */
	@io.vertigo.datamodel.data.stereotype.ForeignKey(smartType = "STyId", label = "Group", fkDefinition = "DtUserGroup", cardinality = io.vertigo.core.lang.Cardinality.ONE )
