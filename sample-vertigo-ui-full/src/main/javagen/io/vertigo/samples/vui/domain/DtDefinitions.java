...
public final class DtDefinitions implements Iterable<Class<?>> {
	 ...
	 */
	public enum ActorFields implements DataFieldName<io.vertigo.samples.vui.domain.Actor> {
		/** Propriété 'Id'. */
		actId,
		/** Propriété 'Nom'. */
		name,
	 ...
	 */
	public enum CountryFields implements DataFieldName<io.vertigo.samples.vui.domain.Country> {
		/** Propriété 'Id'. */
		couId,
	 ...
	 */
	public enum MovieFields implements DataFieldName<io.vertigo.samples.vui.domain.Movie> {
		/** Propriété 'Id'. */
		movId,
	 ...
	 */
	public enum MovieIndexFields implements DataFieldName<io.vertigo.samples.vui.domain.MovieIndex> {
		/** Propriété 'id'. */
		movId,
		/** Propriété 'Titre'. */
		name,
	 ...
	 */
	public enum RoleFields implements DataFieldName<io.vertigo.samples.vui.domain.Role> {
		/** Propriété 'Id'. */
		rolId,
	 ...
	 */
	public enum SexeFields implements DataFieldName<io.vertigo.samples.vui.domain.Sexe> {
		/** Propriété 'Id'. */
		sexCd,
		/** Propriété 'Label'. */
		label	}
	 ...
	 */
	public enum UserFields implements DataFieldName<io.vertigo.samples.vui.domain.User> {
		/** Propriété 'Id'. */
		usrId,
		/** Propriété 'Login'. */
		login,
	 ...
	 */
	public enum UserGroupFields implements DataFieldName<io.vertigo.samples.vui.domain.UserGroup> {
		/** Propriété 'Id'. */
		grpId,
		/** Propriété 'Nom'. */
		name	}
