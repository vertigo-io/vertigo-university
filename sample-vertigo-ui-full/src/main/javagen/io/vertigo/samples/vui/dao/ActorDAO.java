...
public final class ActorDAO extends DAO<Actor, java.lang.Long> implements StoreServices {
 ...
 " 			where mov.mov_id = #movId#",
	...
	public io.vertigo.datamodel.structure.model.DtList<io.vertigo.samples.vui.domain.Actor> getActorsByMovie(@io.vertigo.datamodel.task.proxy.TaskInput(name = "movId", smartType = "STyId") final Long movId) {
