...
public final class Movie implements KeyConcept {
	...
	@io.vertigo.datamodel.structure.stereotype.Association(
			...
			foreignLabel = "Role",
			foreignMultiplicity = "0..*")
	private final StoreListVAccessor<io.vertigo.samples.vui.domain.Role> roleAccessor = new StoreListVAccessor<>(this, "ARolMov", "Role");
	 ...
	 */
	@Field(smartType = "STyLabelLong", cardinality = io.vertigo.core.lang.Cardinality.ONE, label = "Titre du film")
	 ...
	 */
	public StoreListVAccessor<io.vertigo.samples.vui.domain.Role> role() {
		return roleAccessor;
	}
