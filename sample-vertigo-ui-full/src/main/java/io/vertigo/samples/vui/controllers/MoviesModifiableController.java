...
@Controller
@RequestMapping("/moviesModifiable")
public class MoviesModifiableController extends AbstractVSpringMvcController {
	...
	@PostMapping("/_save")
	public String doSave(@ViewAttribute("movies") final DtList<Movie> movies) {
		movieServices.saveList(movies);
		return "redirect:/moviesModifiable/";
	}
}
